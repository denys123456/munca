...
export function ForecastsPage({ data, setActivePage }) {
  ...
  return <div className="page-stack forecast-page">
    ...
    <p className="forecast-disclosure"><SlidersHorizontal />{data.forecastSource === 'live' ? 'Service forecast with illustrative scenarios' : 'Illustrative demo model'}: scenarios and the confidence region are indicative estimates, not guaranteed outcomes.</p>
